...
plt.imshow(outputs.get_array()[0,0,150,:,:], cmap='gray')
plt.subplot(1,14,2)
plt.title('SA_LGEA', fontsize=15)
plt.imshow(outputs.get_array()[0,1,150,:,:], cmap='gray')
plt.subplot(1,14,3)
plt.title('RGEA', fontsize=15)
plt.imshow(outputs.get_array()[0,2,150,:,:], cmap='gray')
plt.subplot(1,14,4)
plt.title('PHA_RHA_LHA', fontsize=15)
plt.imshow(outputs.get_array()[0,3,150,:,:], cmap='gray')
plt.subplot(1,14,5)
plt.title('LGA', fontsize=15)
plt.imshow(outputs.get_array()[0,4,150,:,:], cmap='gray')
plt.subplot(1,14,6)
plt.title('GDA', fontsize=15)
plt.imshow(outputs.get_array()[0,5,150,:,:], cmap='gray')
plt.subplot(1,14,7)
plt.title('CT', fontsize=15)
plt.imshow(outputs.get_array()[0,6,150,:,:], cmap='gray')
plt.subplot(1,14,8)
plt.title('CHA', fontsize=15)
plt.imshow(outputs.get_array()[0,7,150,:,:], cmap='gray')
plt.subplot(1,14,9)
plt.title('Aorta', fontsize=15)
plt.imshow(outputs.get_array()[0,8,150,:,:], cmap='gray')
plt.subplot(1,14,10)
plt.title('middle node BG', fontsize=15)
plt.imshow(outputs.get_array()[0,9,150,:,:], cmap='gray')
plt.subplot(1,14,11)
plt.title('Aorta,CT,SA_LGEA,LGA,CHA,PHA_RHA_LHA', fontsize=15)
plt.imshow(outputs.get_array()[0,10,150,:,:], cmap='gray')
plt.subplot(1,14,12)
plt.title('GDA,RGEA', fontsize=15)
plt.imshow(outputs.get_array()[0,11,150,:,:], cmap='gray')
plt.subplot(1,14,13)
plt.title('top node BG', fontsize=15)
plt.imshow(outputs.get_array()[0,12,150,:,:], cmap='gray')
plt.subplot(1,14,14)
plt.title('Aorta,CT,SA_LGEA,LGA,CHA,PHA_RHA_LHA,GDA,RGEA(FG)', fontsize=15)
plt.imshow(outputs.get_array()[0,13,150,:,:], cmap='gray')
plt.savefig('./_hiera2')
```
